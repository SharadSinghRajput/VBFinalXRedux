...
import { CheckCircleIcon} from '@heroicons/react/20/solid'
  ...
  const ChartList = [
    { value: "sun", label: "Ashtak Varga For Sun" },
    { value: "moon", label: "Ashtak Varga For Moon" },
    { value: "mars", label: "Ashtak Varga For Mars" },
    { value: "mercury", label: "Ashtak Varga For Mercury" },
    { value: "jupiter", label: "Ashtak Varga For Jupiter" },
    { value: "venus", label: "Ashtak Varga For Venus" },
    { value: "saturn", label: "Ashtak Varga For Saturn" }
  ]
...
export default function Kundli({data}) {
    ...
    const [HoroscopeChartBtnActive, setHoroscopeChartBtnActive] = useState("sun");
    

    const HandleGenrateChart = async (value) => {
        setHoroscopeChartBtnActive(value ? value : "sun");
        ...
        if (GetUserDataKundaliForm) {
            ...
            if (TimeZone) {
                ...
                try {
                    const astrologyData = await fetchAstrologyData(data, `planet_ashtak/${value ? value : "sun"}`);
  ...
  return (
    ...
    <div className="">
        <div className={`bg-white mx-auto max-w-6xl mx-auto shadow-2xl p-5 mt-5 mb-5 rounded-lg`}>
            ...
            <h2 className='mb-5 text-lg font-bold'>Select Planet</h2>
            <div>
              <div className='flex mt-5'>
                
                <div className='gap-2 grid grid-cols-4 w-[100%]'>
