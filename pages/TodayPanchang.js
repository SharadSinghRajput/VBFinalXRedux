          ...
          {data ? (
            ...
            {/* <div> 
                <div className="grid grid-cols-3 mt-5 gap-10">
                    ...
                    <div className="flex">
                        <button onClick={()=> setLangButton("हिंदी")} className={`px-5 py-1 ${LangButton === "हिंदी" ? "bg-blue-800 text-white" : "bg-blue-200 text-gray-700"} `}>हिंदी</button>
                        ...
                        <div className="grid grid-cols-2 gap-2 md:grid-cols-2 py-2 bg-white p-4 border-[1px]  border-grey-100 drop-shadow-lg rounded-lg mt-4">
                            <table className="w-full rounded-lg overflow-hidden" >
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Nakshatra</td>
                                        <td>Uttra Phalguni upto 8:14:21 Next : Hast</td>
                                    </tr>
                                    <tr>
                                        <td>Yog</td>
                                        <td>Vyatipaat upto 20:10:38 Next : Variyaan</td>
                                    </tr>
                                    <tr>
                                        <td>Karan</td>
                                        <td>Baalav upto 13:18:44 Next : Taitil</td>
                                    </tr>
                            </tbody>
                            </table>    
                        </div>
