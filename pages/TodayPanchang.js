...
async function chatGPTAnswer(Text) {
  const dataGpt = {
      prompt: `Convert this '${Text}' in hindi`,
      temperature: 0.5,
      max_tokens: 800
  };
  ...
  // return answer ? answer : 'Due to high demand, numerous users are currently downloading this report. Kindly check again after some time. Thank you for your patience.';
}
                  ...
                  <div>
                      ...
                      <div>
                        ...
                        <>
                          <p className="text-base font-light text-white">
                            ...
                            : {PanchangD.ayana}</p>
                          <p className="text-base font-light text-white">Ritu: {PanchangD.ritu}</p>
                        </>
                        : <></>}
                      </div>
                      <div>
                        {PanchangD ?
                        <>
                          <p className="text-base font-light text-white">Sunrise: {PanchangD.vedic_sunrise}</p>
                          <p className="text-base font-light text-white">Sunset: {PanchangD.vedic_sunset}</p>
                        </>
                        : <></>}
                      </div>
                      <div>
                        {PanchangD ?
                        <>
                          <p className="text-base font-light text-white">Sun Sign :
                            {PanchangD.sun_sign}</p>
                          <p className="text-base font-light text-white">Moon Sign : {PanchangD.moon_sign}</p>
                        </>
                        : <></>}
                      </div>
                    </div>
                            ...
                            <>
                                <div className="bg-orange-500 rounded-lg p-1 pt-4" >
                                    ...
                                    <div className="bg-orange-100 p-2 mt-2 rounded-md">
                                        <p className="text-center text-sm text-gray-800">Sunrise</p>
                                ...
                                <div className="bg-orange-500 rounded-lg p-1 pt-4" >
                                    ...
                                    />
                                    <div className="bg-orange-100 p-2 mt-2 rounded-md">
                                        <p className="text-center text-sm text-gray-800">Sunset</p>
                                ...
                                <div className="bg-orange-500 rounded-lg p-1 pt-4" >
                                    ...
                                    />
                                     <div className="bg-orange-100 p-2 mt-2 rounded-md">
                                        <p className="text-center text-sm text-gray-800">Moonrise</p>
                                ...
                                <div className="bg-orange-500 rounded-lg p-1 pt-4" >
                                    ...
                                    />
                                    <div className="bg-orange-100 p-2 mt-2 rounded-md">
                                        <p className="text-center text-sm text-gray-800">Moonset</p>
                        ...
                        <div className="grid grid-cols-1 gap-2 md:grid-cols-1 py-2 bg-white p-4 border-[1px]  border-grey-100 drop-shadow-lg rounded-lg mt-4">
                            <table className="w-full rounded-lg overflow-hidden" >
                                <tbody className="divide-y divide-gray-200">
                                    <tr>
                                        <td className="text-sm text-gray-700">Tithi</td>
                                    ...
                                    <tr>
                                        <td className="text-sm text-gray-700">Nakshatra</td>
                                        <td className="text-sm text-gray-700 font-bold">
                                        {PanchangD ?
                                            PanchangD.nakshatra ?
                                    ...
                                    <tr>
                                        <td className="text-sm text-gray-700">Yog</td>
                                        <td className="text-sm text-gray-700 font-bold">
                                          {PanchangD ?
                                              PanchangD.yog ?
                                    ...
                                    <tr>
                                        <td className="text-sm text-gray-700">Karan</td>
                                        <td className="text-sm text-gray-700 font-bold">
                                        {PanchangD ?
                                            PanchangD.karan ?
                    ...
                    <div className="grid grid-cols-3 gap-5">
                        <table className="w-full bg-blue-800 rounded-lg overflow-hidden mt-5" >
                          <tbody className="divide-y divide-gray-200">
                            <tr>
                              <th colSpan={2} className="bg-orange-500 text-white p-2 h-14">Hindu Month & Year</th>
                            </tr>
                              <tr>
                                  <td className="text-sm text-white p-2">
                                    ...
                                    : null} upto {" "} 
                                    {PanchangD ?
                                        PanchangD.vkram_samvat_name
                                    : null}
                                  </td>
                                  <td className="text-sm text-white p-2">
                                    Shaka Samvat <br />
                                    {PanchangD ?
                                        PanchangD.shaka_samvat
                                    : null} upto {" "} 
                                    {PanchangD ?
                                        PanchangD.shaka_samvat_name
                                    : null}
                                  </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                  <td className="text-sm text-white p-2">
                                    Purnimanta<br />
                                    {PanchangD ?
                                        PanchangD.hindu_maah.purnimanta
                                    : null}
                                  </td>
                                  <td className="text-sm text-white p-2">
                                    Amanta<br />
                                    {PanchangD ?
                                        PanchangD.hindu_maah.amanta
                                    : null}
                                  </td>
                              </tr>
                              <tr>
                        ...
                        <table className="w-full bg-blue-800 rounded-lg overflow-hidden mt-5 h-auto" >
                          <tbody className="divide-y divide-gray-200">
                            <tr>
                              <th colSpan={2} className="bg-orange-500 text-white p-2 h-14">Auspicious Timing</th>
                            </tr>
                              <tr>
                                  <td className="text-sm text-white p-2">
                                    Abhijit Muhurta <br />
                        ...
                        <table className="w-full bg-blue-800 rounded-lg overflow-hidden mt-5 h-auto" >
                          <tbody className="divide-y divide-gray-200">
                            <tr>
                              <th colSpan={2} className="bg-orange-500 text-white p-2 h-14">Other Yoga</th>
                            </tr>
                              <tr>
                                  <td className="text-sm text-white p-2">
                                    Panchang Yog
