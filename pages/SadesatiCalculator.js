            ...
            {data ? (
              ...
              <div className="grid grid-cols-2 max-md:grid-cols-1 mb-10">
                <div className="bg-bgForm p-5 flex justify-center items-center flex-col gap-6">
                  <p className="font-bold text-lg text-white ">{lang === "Hindi" ? "नि: शुल्क साढ़ेसाती कैलकुलेटर" : "Free Sade Sati Calculator"}</p>
                  <Image src={GlobImg} width={100} height={100} />
                </div>
                <div className="p-10 bg-gray-100">
                  {data.language === "Hindi" ? <>
                      <CalculatorForm lang="Hindi" routing={"/hindi/calculator/sadesati-report.php"} />
                    </> : <>
                      <CalculatorForm lang="English" routing={"/calculator/sadesati-report.php"} />
                    </>}
                </div>
              </div>
