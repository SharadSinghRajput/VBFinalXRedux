  ...
  return (
    <>
      <div className={`${showFull ? "h-[100%] pb-24 mb-20" : "h-52"} overflow-hidden transition-all ease-in duration-200 relative z-0`}> 
        <div className={`${showFull ? "grid grid-cols-2 sm:grid-cols-4": "grid grid-cols-2 sm:grid-cols-4" }`}>
              {data.map((item, index) =>(
          ...
          <div className='h-24 bg-gradient-to-t from-orange-50 from-10%  absolute bottom-0 left-0 w-full z-10 flex justify-center items-end'>
            <button
