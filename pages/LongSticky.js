        ...
        <div className="w-full flex h-full justify-between gap-1 flex-col lg:flex-row">
            <div className="flex gap-5 flex-1 justify-center items-center h-full pl-5">
                <div className="flex-1">
                    <p className='mb-2'>Get Social</p>
                    <div className="flex gap-4">
                        <Link href="https://www.vinaybajrangi.com/"><Facebook width={20} height={20} /></Link>
                        <Link href="https://www.vinaybajrangi.com/"><Instagram width={20} height={20} /></Link>
                        <Link href="https://www.vinaybajrangi.com/"><Linkedin width={20} height={20} /></Link>
                        <Link href="https://www.vinaybajrangi.com/"><Twitter width={20} height={20} /></Link>
                        <Link href="https://www.vinaybajrangi.com/"><YouTube width={20} height={20} /></Link>
                    </div>
                </div>
                <div className=" flex-1">
                    <p className='mb-2'>Get Connected</p>
                    <div className="flex gap-4">
                        <Link href="https://www.vinaybajrangi.com/"><Call width={20} height={20} /></Link>
                        <Link href="https://www.vinaybajrangi.com/"><Mail width={20} height={20} /></Link>
                ...
                <button className="flex gap-4 bg-green-500 p-2 justify-center items-center text-white h-full flex-1">
                    <p className="text-white">Click to Get<br />Instant Report</p>
