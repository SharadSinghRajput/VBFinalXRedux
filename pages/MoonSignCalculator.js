                ...
                <Title titleData={data.title} />
                  ...
                  <div className="grid grid-cols-2 max-md:grid-cols-1 mb-10">
                    ...
                    <div className="p-10 bg-gray-100">
                      {data.language === "Hindi" ?
                        <CalculatorForm lang="Hindi" routing={"/hindi/calculator/moon-sign-calculator-result.php"} />
                        :
                        <CalculatorForm lang="English" routing={"/calculator/moon-sign-calculator-result.php"} />
                      }
                    </div>
                  </div>
