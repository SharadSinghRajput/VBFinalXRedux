  ...
  return (
    ...
    <div className='drop-shadow-2xl bg-white p-5 rounded-xl'>
        <form onSubmit={handleSubmit}>
            ...
            {HoroscopeMSecForm ? <>
                <p className="mt-3 block text-sm font-medium leading-6 text-gray-900">Enter {FirstPersonGender === 'Male' ? 'Female':'Male'} Information</p>
