...
export default function BlogList({data}) {
  ...
  return (
    <>
    {data ?
      <div className="relative groupBoulde z-10">
        <span className="text-gray-400 groupBoulde-hover:bg-red-500">
        ...
        <div className="shadow-lg p-0 w-0 absolute h-0 overflow-hidden groupBoulde-hover:h-36 groupBoulde-hover:w-52 groupBoulde-hover:p-2 z-10 bg-white transition-all ease-in duration-200">
