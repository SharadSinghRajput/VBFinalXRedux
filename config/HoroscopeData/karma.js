        ...
        <div>
            <div className="mx-auto max-w-7xl border p-5">
                ...
                <ul role="list" className="mx-auto mt-10 flex justify-center max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 mb-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {AppImageUrl.map((AppImageUrl) => (
                        <li key={AppImageUrl.index}>
                            <Image className=" w-full rounded-2xl object-fit shadow-2xl" src={AppImageUrl.imageUrl} alt="" />
                        </li>
                    ))}
                </ul>
                ...
                >
                    {AppImageUrl.map((AppImageUrl) => (
                        <li key={AppImageUrl.index}>
                            <Image className=" w-full rounded-2xl object-fit shadow-2xl" src={AppImageUrl.imagBanner} alt="" />
                        </li>
                    ))}
                </ul>
