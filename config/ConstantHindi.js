...
export const MainMenuHindi = [
    ...
    { name: 'राशिफल', url : '#', 
        sublinks: [
            ...
            { name: 'वार्षिक राशिफल  2025', url : `${MAIN_URL_HINDI}horoscope/horoscope-prediction-2025.php`,
                sublinksL2: [
                    { name: 'वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/horoscope-prediction-2025.php`,},
                    { name: 'वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/aries-horoscope-2025.php`,},
                    { name: 'वृषभ राशि वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/taurus-horoscope-2025.php`,},
                    { name: 'मिथुन वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/gemini-horoscope-2025.php`,},
                    { name: 'कर्क वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/cancer-horoscope-2025.php`,},
                    { name: 'सिंह वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/leo-horoscope-2025.php`,},
                    { name: 'कन्या वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/virgo-horoscope-2025.php`,},
                    { name: 'तुला वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/libra-horoscope-2025.php`,},
                    { name: 'वृश्चिक वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/scorpio-horoscope-2025.php`,},
                    { name: 'धनु वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/sagittarius-horoscope-2025.php`,},
                    { name: 'मकर वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/capricorn-horoscope-2025.php`,},
                    { name: 'कुंभ वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/aquarius-horoscope-2025.php`,},
                    { name: 'मीन वार्षिक राशिफल 2025', url : `${MAIN_URL_HINDI}horoscope/pisces-horoscope-2025.php`,}
                ]
            }
        ]
    },
    { name: 'राशिफल 2024', url : '#',
        sublinks: [
            { name: 'वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/horoscope-2024.php`,},
            { name: 'मेष राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/aries-horoscope-2024.php`,},
            { name: 'वृषभ राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/taurus-horoscope-2024.php`,},
            { name: 'मिथुन राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/gemini-horoscope-2024.php`,},
            { name: 'कर्क राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/cancer-horoscope-2024.php`,},
            { name: 'सिंह राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/leo-horoscope-2024.php`,},
            { name: 'कन्या राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/virgo-horoscope-2024.php`,},
            { name: 'तुला राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/libra-horoscope-2024.php`,},
            { name: 'वृश्चिक राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/scorpio-horoscope-2024.php`,},
            { name: 'धनु राशि वार्षिक राशिफल 2024s', url : `${MAIN_URL_HINDI}horoscope/sagittarius-horoscope-2024.php`,},
            { name: 'मकर राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/capricorn-horoscope-2024.php`,},
            { name: 'कुंभ राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/aquarius-horoscope-2024.php`,},
            { name: 'मीन राशि वार्षिक राशिफल 2024', url : `${MAIN_URL_HINDI}horoscope/pisces-horoscope-2024.php`,}
        ]
    },
    { name: 'ज्योतिष ', url : '#',
        sublinks: [
            ...
            { name: "हिंदू अनुष्ठान और इसका महत्व", url : `${MAIN_URL_HINDI}hindu-rituals.php`,
                sublinksL2 :[
                    { name: "आरती का महत्व", url: `${MAIN_URL_HINDI}why-do-we-perform-aarti.php` },
                    { name: "मुंडन संस्कार क्या है और बच्चो का मुंडन क्यों किया जाता है ?", url: `${MAIN_URL_HINDI}mundan.php` },
                    { name: "धार्मिक कार्यों में पीताम्बर धारण क्यों?", url: `${MAIN_URL_HINDI}importance-of-pitambar-in-hindu-rituals.php` },
                    { name: "अन्नप्राशन संस्कार", url: `${MAIN_URL_HINDI}why-annaprashan-ceremony-is-important.php` },
                    { name: "अश्विन मास में श्राद्ध क्यों किए जाता है?", url: `${MAIN_URL_HINDI}why-shradh-is-observed-in-ashwin.php` },
                    { name: "उपवास के वैदिक लाभ", url: `${MAIN_URL_HINDI}why-do-people-keep-fast.php` },
                    { name: "रुद्राभिषेक करने के कारण और परिणाम", url: `${MAIN_URL_HINDI}why-do-we-perform-abhishekam-to-god.php` },
                    { name: "आकस्मिक मृत्यु या लापता व्यक्ति का अंतिम संस्कार", url: `${MAIN_URL_HINDI}funeral-rites-for-missing-or-accidental-death.php` },
                    { name: "भगवान के विभिन्न अवतार", url: `${MAIN_URL_HINDI}why-did-the-god-take-various-incarnations.php` },
                    { name: "अधिकमास या मलमास", url: `${MAIN_URL_HINDI}adhikmas-or-malmas.php` },
                    { name: "ईश्वर की कृपा", url: `${MAIN_URL_HINDI}grace-of-god.php` },
                    { name: "आचमन", url: `${MAIN_URL_HINDI}aachman.php` },
                    { name: "कपाल क्रिया", url: `${MAIN_URL_HINDI}kapaal-kriya-during-funeral.php` },
                    { name: "कलश स्थापना", url: `${MAIN_URL_HINDI}why-and-when-do-we-use-kalash.php` },
                    { name: "गंगाजल", url: `${MAIN_URL_HINDI}importance-of-gangajal.php` },
                    { name: "जातकर्म व नामकरण संस्कार", url: `${MAIN_URL_HINDI}importance-of-naming-ceremony.php` }
                ]
            },
    ...
    },
    {
        ...
        sublinks: [
            ...
            { name: "कुंडली मिलान", url: `${MAIN_URL_HINDI}marriage-astrology/kundli-matching-horoscopes-matching-for-marriage.php`,},
